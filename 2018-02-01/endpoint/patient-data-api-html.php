...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="patient-data-style.css">
	</head>
		...
		<div id="container">
			...
			<main>
				...
				?> -->
					<!-- Top Half of Form -->
					<div class="row">
						<div class="caption">NAME:</div><div id="patient-name">N/A</div> 
			...
			<script type="text/javascript" src="patient-data-script.js"></script>
			<script src="patient-data-time.js"></script>
		</div>
	</body>
</html>